...
CREATE TABLE `rawincidents` (
  ...
  `Total shots fired by police` varchar(100) DEFAULT NULL,
  `Total shots that hit suspect` varchar(100) DEFAULT NULL,
  `Number of cops who fired` varchar(100) DEFAULT NULL,
  `Number of suspects shot or shot at` varchar(100) DEFAULT NULL,
